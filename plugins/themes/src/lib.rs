...
const PALETTES: &[(&str, &[(&str, &str)])] = &[
    ...
    ("nord", &[
        ...
        ("reasoning", "#616e88"), ("tool", "#ebcb8b"), ("tool_output", "#616e88"), ("error", "#ef4444"),
    ...
    ("catppuccin-mocha", &[
        ...
        ("reasoning", "#7f849c"), ("tool", "#fab387"), ("tool_output", "#7f849c"), ("error", "#ef4444"),
    ...
    ("tokyo-night", &[
        ...
        ("reasoning", "#565f89"), ("tool", "#ff9e64"), ("tool_output", "#565f89"), ("error", "#ef4444"),
    ...
    ("monokai", &[
        ...
        ("reasoning", "#75715e"), ("tool", "#fd971f"), ("tool_output", "#75715e"), ("error", "#ef4444"),
